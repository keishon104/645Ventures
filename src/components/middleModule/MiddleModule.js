      ...
      <div>
        ...
        <VerticalTimeline>
          ...
          <VerticalTimelineElement
            ...
            iconStyle={{ background: 'rgb(33, 150, 243)', color: '#fff' }}
          >
            <h4 className="vertical-timeline-element-subtitle">Fixes V1 Bugs</h4>
          </VerticalTimelineElement>
          <VerticalTimelineElement
            className="vertical-timeline-element--work"
            date="2/15/19"
            iconStyle={{ background: 'rgb(33, 150, 243)', color: '#fff' }}
          >
            <h4 className="vertical-timeline-element-subtitle">Launches V2</h4>
          </VerticalTimelineElement>
          <VerticalTimelineElement
            className="vertical-timeline-element--work"
            date="2/20/19"
            iconStyle={{ background: 'rgb(33, 150, 243)', color: '#fff' }}
          >
            <h4 className="vertical-timeline-element-subtitle">Beta Test of V2</h4>
